...
**注意：！！！官方限制了开发版的自唤醒任务，原方案已失效。**
![](https://cdn.jsdelivr.net/gh/zuertx/Image-hosting/images/valine4.png)
...
1. Fork该项目
2. 添加一个名为GITHUB_TOKEN的Token，并为赋予repo，admin:repo_hook ， workflow的权限
...
```
$ git clone https://github.com/zuertx/Valine-Admin.git
$ cd Valine-Admin
```
